...
public class GenericDaoImpl<T> implements IGenericDao<T> {
	 ...
	 * @return
	 */
	private String getNameSpace(Object object){
		if(object == null)
			return null;
		Class<?> clazz = object.getClass();
		if (clazz.isAnnotationPresent(EntrtyNamespace.class)){
			/*获取WFSEntityAnnotation*/
			EntrtyNamespace annotation = clazz.getAnnotation(EntrtyNamespace.class);
			/*设置namespace*/
			return annotation.nameSapce();
		}
	...
	/**
	* @MethodName: insert 
	* @description   :  插入单条。实体关系映射中方法id必须为insert
	* @author:李在标
	* @param entity
	*/
	@Override
	public int insert( T entity) {
		...
		int flag = sqlSessionTemplate.insert(namespace + ".insert",entity);
		/*sqlSession.commit();*/
		return flag; 
	}
